...
void CGameTarget::InitGame()
{
	...
	if (GLOBAL_SoundEnable)
	{
		...
		//filename = resource_dir + "titleShort.s3m";
		m_MOD_title = CL_SoundBuffer(filename);

		filename = resource_dir + "tune1.mod";
		//filename = resource_dir + "a_world_in_a_nut.mod";
		m_MOD_tune1 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune2.mod";
		//filename = resource_dir + "robot-9d.xm";
		m_MOD_tune2 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune1.mod";
		//filename = resource_dir + "ngz-suxy.xm";
		m_MOD_tune3 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune2.mod";
		//filename = resource_dir + "4mat_-_broken_heart.xm";
		m_MOD_tune4 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune1.mod";
		//filename = resource_dir + "69513-chippie.xm";
		m_MOD_tune5 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune2.mod";
		//filename = resource_dir + "81590-4wd.s3m";
		m_MOD_tune6 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune1.mod";
		//filename = resource_dir + "8g_crim.xm";
		m_MOD_tune7 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune2.mod";
		//filename = resource_dir + "a_funny_moment.mod";
		m_MOD_tune8 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune1.mod";
		m_MOD_tune9 = CL_SoundBuffer(filename);

		filename = resource_dir + "tune2.mod";
		m_MOD_tune10 = CL_SoundBuffer(filename);
	}
...
void CGameTarget::PlayModule(int id)
{
	...
	switch(id)
	{
		...
		case SMOD_TUNE2: 
			...
			break;
		case SMOD_TUNE3: 
			sound_ptr = &m_MOD_tune3;
			break;
		case SMOD_TUNE4: 
			sound_ptr = &m_MOD_tune4;
			break;
		case SMOD_TUNE5: 
			sound_ptr = &m_MOD_tune5;
			break;
		case SMOD_TUNE6: 
			sound_ptr = &m_MOD_tune6;
			break;
		case SMOD_TUNE7: 
			sound_ptr = &m_MOD_tune7;
			break;
		case SMOD_TUNE8: 
			sound_ptr = &m_MOD_tune8;
			break;
		case SMOD_TUNE9: 
			sound_ptr = &m_MOD_tune9;
			break;
		case SMOD_TUNE10: 
			sound_ptr = &m_MOD_tune10;
			break;
		case SMOD_BOSS: 
	...
	StopModule();
	m_Session = CL_SoundBuffer_Session(sound_ptr->prepare(true));
	m_Session.play();
